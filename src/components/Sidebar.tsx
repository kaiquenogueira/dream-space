      ...
      <div className="glass-card p-4">
        <div className="flex justify-between items-end mb-3">
          <div>
            ...
            <p className="text-xs text-zinc-500 mt-0.5">Manage your uploaded photos</p>
          </div>
          ...
          {images.map((img, i) => (
            ...
            >
              ...
              {!img.isGenerating && img.generatedUrl && (
                <div className="absolute top-1.5 left-1.5 flex items-center gap-1 bg-emerald-500/90 backdrop-blur text-white text-[10px] font-bold px-2 py-0.5 rounded-full shadow-lg">
                  <span>✓ Done</span>
                </div>
              )}
