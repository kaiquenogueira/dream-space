          ...
          <textarea
            ...
            placeholder={
              generationMode === GenerationMode.PAINT_ONLY
                ? "Ex: Azul marinho fosco, Bege areia, Textura de cimento queimado..."
                : "Descreva detalhes específicos (ex: 'Pintar as paredes de verde sálvia, adicionar uma poltrona de couro...')"
            }
